...
plt.plot(t,Pp1,'-',linewidth=1,color=[0.33,0.51,0.70],label= 'Pp(t):Hipotenso')
...
fg2.tight_layout()
fg2.savefig('sistema cardiovascular Hipotenso PI python.png',dpi=600,bbox_inches='tight')
fg2.savefig('sistema cardiovascular Hipotenso PI python.pdf')
...
fg3.tight_layout()
fg3.savefig('sistema cardiovascular Hipertenso PI python.png',dpi=600,bbox_inches='tight')
fg3.savefig('sistema cardiovascular Hipertenso PI python.pdf')
